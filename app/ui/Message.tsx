...
export default function Message({ message, replied, setReplying }: Props) {
    ...
    return (
        <div id={`${message.id}`} /* onDoubleClick={() => replyActive(message.id)} */ className='border first:mt-4 rounded-lg p-2 my-1 flex flex-col gap-1 w-fit min-w-[40vw] max-w-[80vw] scroll-mt-40 backdrop-blur transition-all message'>

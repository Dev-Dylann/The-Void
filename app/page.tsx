...
export default function Home() {
  ...
  return (
    <main className='relative row-span-full flex flex-col'>
      ...
      <section className='w-full h-full bg-gradient-to-b from-transparent from-10% to-darkBg to-80% p-5 pb-12 flex flex-col justify-end text-center sm:p-10 sm:pb-16 md:pb-24 md:from-5% md:to-70% lg:flex-row lg:gap-12 lg:justify-between lg:items-center lg:text-left lg:pb-10 lg:p-12 lg:radial-gradient'>

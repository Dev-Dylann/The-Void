    ...
    return (
        <form action="" className="flex flex-col gap-4 pt-6">
            ...
            <label htmlFor="voidName" className='flex flex-col gap-1'>
                Void Name:
                <input type="text" name="voidName" id="voidName" placeholder='e.g. "The Boys"' autoFocus className='text-sm bg-transparent outline-none rounded-lg border border-white backdrop-blur py-2 px-4 focus:border-2' />
            </label>
